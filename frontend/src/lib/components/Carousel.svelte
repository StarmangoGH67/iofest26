...
<style lang="scss">
    ...
    .theme-warning { background: linear-gradient(135deg, #b45309 0%, #92400e 100%); }
    .theme-new { background: linear-gradient(135deg, #1A7A50 0%, #0B4D33 100%); }
    .theme-info { background: linear-gradient(135deg, #1e3a8a 0%, #1e40af 100%); }
