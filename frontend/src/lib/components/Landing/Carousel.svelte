...
<div
	class="carousel-container mt-2.5 w-full min-w-full sm:max-w-[70vw] sm:min-w-[70vw] lg:mt-0 lg:h-50 lg:min-w-[50%]"
>
	<div
...
<style lang="scss">
	...
	.theme-warning {
		background: linear-gradient(135deg, #b9852b 0%, #d8bc3f 100%);
	}
	.theme-emergency {
		background: linear-gradient(135deg, #8a1e20 0%, #eb2532 100%);
	}
	.theme-info {
		background: linear-gradient(135deg, #1e3a8a 0%, #2563eb 100%);
	}
	.theme-news {
		background: linear-gradient(135deg, #1b7f52 0%, #1cb150 100%);
	}
