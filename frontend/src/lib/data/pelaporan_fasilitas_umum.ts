...
export const FasumHeaderData = {
	...
	description:
		'Selamat datang di Portal Pelaporan Fasilitas Umum Online. Tempat dimana Anda bisa membuat laporan terkait kerusakan fasilitas umum di lingkungan sekitar Anda.',
